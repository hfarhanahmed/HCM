        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                _MoodButton(type: MoodType.happy,
                    color: Colors.greenAccent,
                    onTap: () => _addMood(MoodType.happy)),
                _MoodButton(type: MoodType.neutral,
                    color: Colors.yellowAccent,
                    onTap: () => _addMood(MoodType.neutral)),
                _MoodButton(type: MoodType.sad,
                    color: Colors.blueAccent,
                    onTap: () => _addMood(MoodType.sad)),
              ],
            ),
...
class _MoodButton extends StatelessWidget {
  ...
  const _MoodButton(
      {required this.type, required this.color, required this.required this.onTap});
...
class _TimelineCardState extends State<TimelineCard>
  ...
  Widget build(BuildContext context) {
    ...
    switch (widget.entry.type) {
      case MoodType.happy:
        moodColor = Colors.greenAccent;
        break;
      case MoodType.neutral:
        moodColor = Colors.yellowAccent;
        break;
      case MoodType.sad:
...
class MoodPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(
        center + Offset(-eyeOffsetX, eyeOffsetY), size.width * 0.06, eyePaint);
    canvas.drawCircle(
        center + Offset(eyeOffsetX, eyeOffsetY), size.width * 0.06, eyePaint);
